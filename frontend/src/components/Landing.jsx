    ...
    <div className="w-full font-['Inter',sans-serif]">
      ...
      <nav className="sticky top-0 bg-white/95 backdrop-blur-md border-b border-gray-200 z-50 py-4" data-testid="main-navigation">
        <div className="max-w-7xl mx-auto px-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-gray-600 hover:text-[#004E92] font-medium text-[15px]" data-testid="nav-features-link">Features</a>
            <a href="#benefits" className="text-gray-600 hover:text-[#004E92] font-medium text-[15px]" data-testid="nav-benefits-link">Benefits</a>
            <button className="bg-[#004E92] text-white px-6 py-2.5 rounded-lg font-semibold text-[15px] hover:bg-[#003d75]" data-testid="nav-cta-button" onClick={handleRoute}>
              Get Started
            </button>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden flex flex-col gap-4 px-8 py-4 bg-white border-t border-gray-200" data-testid="mobile-menu">
            ...
            <button className="bg-[#004E92] text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-[#003d75]" onClick={handleTrial} data-testid="mobile-cta-button">
              Get Started
            </button>
          </div>
        )}
      ...
      <section className="max-w-7xl mx-auto px-8 py-20 grid md:grid-cols-2 gap-16 items-center" data-testid="hero-section">
        <div className="flex flex-col gap-6">
          ...
          <button
            className="bg-[#004E92] text-white px-8 py-4 rounded-xl font-semibold flex items-center hover:bg-[#003d75]"
      ...
      <section id="features" className="max-w-7xl mx-auto px-8 py-20" data-testid="features-section">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-white border border-gray-200 rounded-xl p-8 hover:shadow-[0_12px_40px_rgba(0,78,146,0.12)] transition-all" data-testid={`feature-card-${index}`}>
              ...
              <p className="text-[15px] text-gray-600" data-testid={`feature-description-${index}`}>
                {feature.description}
              </p>
            </div>
          ))}
      ...
      <section id="benefits" className="bg-gray-50 py-20" data-testid="benefits-section">
        <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-16 items-center">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-lg text-gray-600" data-testid="benefits-intro">
            ...
            <div className="flex flex-col gap-4">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-3 text-base text-gray-700" data-testid={`benefit-item-${index}`}>
                  <CheckCircle className="w-6 h-6 text-[#004E92]" />
                  <span>{benefit}</span>
                </div>
              ))}
            </div>
      ...
      <section className="max-w-7xl mx-auto px-8 py-20" data-testid="cta-section">
        <div className="bg-gradient-to-br from-[#004E92] to-[#0066b8] rounded-3xl p-16 text-center text-white">
          ...
          <button
            className="bg-white text-[#004E92] px-10 py-4 rounded-xl font-semibold inline-flex items-center hover:shadow-lg hover:-translate-y-0.5 transition-all"
      ...
      <footer className="bg-gray-900 text-white py-12 px-8" data-testid="footer">
        <div className="max-w-7xl mx-auto grid md:grid-cols-[2fr_3fr] gap-16 mb-8">
          <div className="flex flex-col gap-4">
            <span className="font-['Space_Grotesk',sans-serif] text-2xl font-bold">CRUXCRM</span>
